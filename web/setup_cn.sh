...
mcsmanager_download_url=$(curl -s https://api.github.com/repos/MCSManager/MCSManager/releases/latest | grep -o 'https://.*linux.*\.tar\.gz')
...
Install_MCSManager() {
  ...
  rm -rf "${mcsmanager_install_path}/daemon"
